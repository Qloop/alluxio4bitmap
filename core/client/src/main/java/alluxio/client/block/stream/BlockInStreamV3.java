 ...
 * {@link BlockInStreamV3}s can be opened for a block.
 *
 ...
 */
@NotThreadSafe
public  class BlockInStreamV3 extends FilterInputStream implements BoundedStream, Seekable,
  ...
  protected final boolean mLocal;
  protected final PacketInStream mInputStream;

  /**
   * Creates an instance of local {@link BlockInStreamV3} that reads from local worker.
   *
   ...
   * @return the {@link BlockInStreamV3} created
   */
  public static BlockInStreamV3 createLocalBlockInStream(long blockId, long blockSize,
  ...
  /**
   * Creates an instance of remote {@link BlockInStreamV3} that reads from a remote worker.
   *
   * @param blockId the block ID
   * @param blockSize the block size
   * @param workerNetAddress the worker network address
   ...
   * @return the {@link BlockInStreamV3} created
   */
  public static BlockInStreamV3 createRemoteBlockInStream(long blockId, long blockSize,
                                                          WorkerNetAddress workerNetAddress, FileSystemContext context, InStreamOptions options)
    throws IOException {
    Closer closer = Closer.create();
  ...
  /**
   * Creates an instance of {@link BlockInStreamV3}.
   *
   ...
   * @throws IOException if it fails to create an instance
   */
  protected BlockInStreamV3(PacketInStream inputStream, long blockId,
