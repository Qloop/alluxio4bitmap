...
public class Input4LongV2Test {
  ...
  protected static final int UNIT_SIZE = Long.BYTES;
  ...
  public void singleReadPos() throws Exception {
    for (int i = 0; i < UNIT_LENGTH; i++) {
      Assert.assertEquals(i, mTestStream.readLong(i * UNIT_SIZE));
  ...
  public void randomRead() throws Exception {
    ...
    for (int i = 0; i < time; i++) {
      ...
      Assert.assertEquals((long) p, (long) mTestStream.readLong(p * UNIT_SIZE));
    }
  }
