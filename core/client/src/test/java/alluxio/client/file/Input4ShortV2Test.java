...
public class Input4ShortV2Test {
  ...
  protected static final int UNIT_SIZE = Short.BYTES;
  ...
  public void singleReadPos() throws Exception {
    for (int i = 0; i < UNIT_LENGTH; i++) {
      Assert.assertEquals(i, mTestStream.readShort(i * UNIT_SIZE));
  ...
  public void randomRead() throws Exception {
    ...
    for (int i = 0; i < time; i++) {
      ...
      Assert.assertEquals((short) p, (short) mTestStream.readShort(p * UNIT_SIZE));
    }
  }
  ...
  public void sequenceSeek() throws IOException {
    ...
    long fl = UNIT_LENGTH;
    for (int i = 0; i < fl; i++) {
      mTestStream.seek((short) i * UNIT_SIZE);
  ...
  public void sequenceSkip() throws IOException {
    ...
    for (int i = 0; i < UNIT_LENGTH / 2; i++) {
      mTestStream.skip((short) UNIT_SIZE);
      v += 1;
