...
/**
 * Tests for the {@link BufferedBlockInStreamV2} class.
 */
public class BufferedBlockInStreamV2Test {
  private TestBufferedBlockInStreamV2 mTestStream;
  ...
  @Before
  public void before() {
    mBufferSize = Configuration.getBytes(PropertyKey.USER_BLOCK_REMOTE_READ_BUFFER_SIZE_BYTES) * 10;
    mBlockSize = mBufferSize;
    mTestStream = new TestBufferedBlockInStreamV2(1L,
