 ...
 */
public class TestBufferedBlockInStreamV3 extends BufferedBlockInStreamV3 {
  private final byte[] mData;

  /**
   * Constructs a new {@link TestBufferedBlockInStreamV3} to be used in tests.
   *
   * @param blockId the id of the block
   * @param data data to read
   */
  public TestBufferedBlockInStreamV3(long blockId, byte[] data) {
