 ...
 */
public final class LocalBlockInStreamV2IntegrationTest {
  ...
  private static CreateFileOptions sWriteUFS;
  ...
  public static final void beforeClass() throws Exception {
    ...
    sWriteUFS = CreateFileOptions.defaults().setWriteType(WriteType.THROUGH);
