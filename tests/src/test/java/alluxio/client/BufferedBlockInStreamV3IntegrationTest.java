 ...
 */
public final class BufferedBlockInStreamV3IntegrationTest {
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV3#read(byte[])}.
   */
  @Test
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV3#read(byte[], int, int)}.
   */
  @Test
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV3#skip(long)}.
   */
  @Test
