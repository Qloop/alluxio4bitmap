 ...
 */
public final class BufferedBlockInStreamV2IntegrationTest {
  ...
  public static final void beforeClass() throws Exception {
    ...
    sWriteBoth = CreateFileOptions.defaults().setWriteType(WriteType.CACHE_THROUGH).setBlockSizeBytes(100_000_000);
    sWriteAlluxio = CreateFileOptions.defaults().setWriteType(WriteType.MUST_CACHE).setBlockSizeBytes(100_000_000);
    sWriteUnderStore = CreateFileOptions.defaults().setWriteType(WriteType.THROUGH).setBlockSizeBytes(100_000_000);
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV2#read()}.
   */
  @Test
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV2#read(byte[])}.
   */
  @Test
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV2#read(byte[], int, int)}.
   */
  @Test
  ...
  /**
   * Tests {@link alluxio.client.block.BufferedBlockInStreamV2#skip(long)}.
   */
  @Test
