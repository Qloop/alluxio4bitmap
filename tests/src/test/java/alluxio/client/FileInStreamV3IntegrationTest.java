 ...
 */
public final class FileInStreamV3IntegrationTest {
  ...
  /**
   * Tests {@link FileInStreamV3#read()} across block boundary.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#read(byte[])}.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#read(byte[], int, int)}.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#read(byte[], int, int)} for end of file.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#seek(long)}. Validate the expected exception for seeking a negative
   * position.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#seek(long)}. Validate the expected exception for seeking a position
   * that is past EOF.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#seek(long)}.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#seek(long)} when at the end of a file at the block boundary.
   */
  @Test
  ...
  /**
   * Tests {@link FileInStreamV3#skip(long)}.
   */
  @Test
  ...
  public void testRead() throws Exception {
    for (int k = MIN_LEN; k <= MAX_LEN; k += DELTA) {
      for (CreateFileOptions op : getOptionSet()) {
        ...
        FileInStream is = sFileSystem.openFile(uri, FileSystemTestUtils.toOpenFileOptions(op).setReadType(ReadType.CACHE_PROMOTE));
        long len = is.remaining();
        for (int i = 0; i < len; i++) {
